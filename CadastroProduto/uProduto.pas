...
type
  ...
  public
    constructor Create(pID: Integer; pDescricao, pUnidade, pObs: String; pEstoque: Extended); overload;
    procedure Novo;
    { public declarations }
  published
...
constructor TProduto.Create(pID: Integer; pDescricao, pUnidade, pObs: String;
  pEstoque: Extended);
begin
     inherited Create;
