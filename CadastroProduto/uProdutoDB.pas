...
begin
     try
        ...
        Result := TProduto.Create(FFDQuery.FieldByName('id').AsInteger,
                                  FFDQuery.FieldByName('nome').AsString,
                                  FFDQuery.FieldByName('unidade').AsString,
                                  FFDQuery.FieldByName('observacao').AsString,
                                  FFDQuery.FieldByName('estoque').AsFloat);
     finally
        LimparFDQuery;
     end;
end;
...
function TProdutoDB.ListaProdutos: TArray<TProduto>;
var i: Integer;
    xSQL : String;
begin
     try
        ...
        begin
             ...
             begin
                  Result[i] := TProduto.Create(FFDQuery.FieldByName('id').AsInteger,
                                               FFDQuery.FieldByName('nome').AsString,
                                               FFDQuery.FieldByName('unidade').AsString,
                                               FFDQuery.FieldByName('observacao').AsString,
                                               FFDQuery.FieldByName('estoque').AsExtended);
